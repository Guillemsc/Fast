...
namespace Fast.UI
{
    public class CurrSubFormPlayAnimationInstruction : Fast.UI.UIInstruction
    {
        ...
        public CurrSubFormPlayAnimationInstruction(string animation_name, Fast.UI.FormAnimationDirection direction,
